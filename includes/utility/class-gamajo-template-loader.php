...
if ( ! class_exists( 'Gamajo_Template_Loader' ) ) {
	...
	class Gamajo_Template_Loader {
		 ...
		 * @var string
		 */
		protected string $filter_prefix = 'your_plugin';
		 ...
		 * @var string
		 */
		protected string $theme_template_directory = 'plugin-templates';
		 ...
		 * @var string
		 */
		protected string $plugin_directory = 'YOUR_PLUGIN_DIR';
		 ...
		 * @var array
		 */
		private array $template_data_var_names = [ 'data' ];
		 ...
		 * @since 1.0.0
		 */
		public function get_template_part( string $slug, $name = NULL, bool $load = TRUE ): bool|string {
		 ...
		 *
		 */
		public function set_template_data( mixed $data, string $var_name = 'data' ): static {
			global $wp_query;
		 ...
		 *
		 */
		public function unset_template_data(): static {
			global $wp_query;
		 ...
		 *
		 */
		protected function get_template_file_names( string $slug, string|null $name ): array {
			$templates = [];
			if ( isset( $name ) ) {
		 ...
		 *
		 * @param array|string $template_names Template file(s) to search for, in order.
		 * @param bool $load If true the template file will be loaded if it is found.
		 * @param bool $require_once Whether to require_once or require. Default true.
		 *                                     Has no effect if $load is false.
		 *
		 * @return bool|string The template filename if one is located.
		 * @since 1.0.0
		 */
		public function locate_template( array|string $template_names, bool $load = FALSE, bool $require_once = TRUE ): bool|string {
